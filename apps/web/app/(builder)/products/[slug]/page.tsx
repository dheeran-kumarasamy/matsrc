  ...
  return (
    <div className="space-y-6">
      ...
      <nav className="text-xs text-slate-400 flex gap-2">
        ...
        <span>/</span>
        <span className="text-slate-600 capitalize">{params.slug.replace(/-/g, " ")}</span>
      </nav>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-5">
          <div className="panel p-5">
            <div className="flex items-start justify-between">
              <div>
                <h1 className="text-2xl font-bold text-slate-900">TMT Bar Fe-500D</h1>
                <p className="text-sm text-slate-400 mt-1">IS 1786 · Grade Fe-500D · BIS Certified</p>
              </div>
        ...
        <div className="space-y-4">
          <div className="panel p-5 sticky top-20">
            {/* Live price — FR-06 */}
            <div className="text-3xl font-bold text-slate-900">₹62,400 <span className="text-base font-normal text-slate-400">/ MT</span></div>
            ...
            <div className="mt-4 pt-4 border-t border-gray-100">
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-sm font-medium text-slate-700">Raipur Steel Co.</p>
                  <p className="text-xs text-slate-400">⭐ 4.8 · 120 orders</p>
                </div>
              </div>
            </div>
          </div>
