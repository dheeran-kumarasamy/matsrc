...
export default function SupplierSocialProof({
  ...
  return (
    <div className={`rounded-2xl border px-4 py-3 text-sm ${acceptedContext ? "border-[color:var(--posh-border)] bg-[rgba(var(--posh-wash-rgb),0.03)]" : "border-[color:var(--posh-border)] bg-[color:var(--posh-bg-card)]"}`}>
