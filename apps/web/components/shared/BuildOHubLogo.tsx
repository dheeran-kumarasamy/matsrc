...
//
// The ring "O" is a hollow letterform (transparent fill + colored stroke
// via -webkit-text-stroke) rather than a filled circle, to match the
// uploaded logo's outlined-ring style exactly.
//
